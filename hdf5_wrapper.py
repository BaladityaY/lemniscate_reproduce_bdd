...
class DB_manager(object):
    ...
    def __init__(self, preload_to_mem, keep_memory_free):
        ...
        # The db manager holds three dictionaries for references to the data.
        # Those references are either pointer to memory, file handles or path strings
        # depending on which there is memory left, there are filehandles left or none
        self.in_memory = defaultdict()
        self.only_opened = defaultdict()
        self.not_opened = defaultdict()
